...
(cl:defmethod cl:initialize-instance :after ((m <IoTSensor1>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'IoTSensor1)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name first_package-msg:<IoTSensor1> is deprecated: use first_package-msg:IoTSensor1 instead.")))
...
(cl:defmethod temperature-val ((m <IoTSensor1>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader first_package-msg:temperature-val is deprecated.  Use first_package-msg:temperature instead.")
  (temperature m))

(cl:ensure-generic-function 'humidity-val :lambda-list '(m))
(cl:defmethod humidity-val ((m <IoTSensor1>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader first_package-msg:humidity-val is deprecated.  Use first_package-msg:humidity instead.")
  (humidity m))
